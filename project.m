...
% Last Modified by GUIDE v2.5 24-May-2022 14:28:45
...
global a7;global b7;global g7;global N7;global fs;
myband1='6 - 12 kHz';
setappdata(0,'a',N7);
setappdata(0,'b',myband1);
setappdata(0,'c',g7);
...
if radio_iir == 1
    ...
    %Design FIR Filters.
    N1=450;N1=450;N2=450;N3=450;N4=450;N5=450;N6=450;N7=450;N8=450;N9=450;
    b1 = fir1(N1,170/fmax);a1=1;
    b2 = fir1(N2,[170/fmax, 310/fmax]);a2=1;
    b3 = fir1(N3,[310/fmax, 600/fmax]);a3=1;
    b4 = fir1(N4,[600/fmax, 1000/fmax]);a4=1; 
    b5 = fir1(N5,[1000/fmax, 3000/fmax]);a5=1;
    b6 = fir1(N6,[3000/fmax, 6000/fmax]);a6=1;
    b7 = fir1(N7,[6000/fmax, 12000/fmax]);a7=1;
    b8 = fir1(N8,[12000/fmax, 14000/fmax]);a8=1;
    b9 = fir1(N9,[14000/fmax, 16000/fmax]);a9=1;    
end
...
% Hint: get(hObject,'Value') returns toggle state of mag
...
% Hint: get(hObject,'Value') returns toggle state of phase
